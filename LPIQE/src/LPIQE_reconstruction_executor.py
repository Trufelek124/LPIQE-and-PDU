...
from LPIQE.src.LPIQE_representation import OperatorType as ot
import numpy as np
...
class LpiqeReconstructionExecutor:
    ...
    def create_circuit(self, image: np.ndarray):
        """
        This method creates circuit for given image.
    ...
    def computation_results(self):
        ...
        :return: reconstructed image
        """
        return self.__repr.results

    @property
    def circuit(self):
        return self.__q_circ
